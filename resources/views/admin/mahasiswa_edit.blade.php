    ...
    <div class="content">
        ...
        <form action="{{ route('admin.mahasiswa.update', $mahasiswa->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="fakultas" class="form-control" id="fakultas" value="{{ old('fakultas', $mahasiswa->fakultas) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="status" id="status" class="form-control" required>
                    ...
                    <option value="0" {{ old('status', $mahasiswa->status) == 0 ? 'selected' : '' }}>Nonaktif</option>
                </select>
            </div>
