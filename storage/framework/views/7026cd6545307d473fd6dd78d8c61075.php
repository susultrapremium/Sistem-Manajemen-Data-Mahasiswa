...
<body>
    ...
    <nav class="navbar navbar-light bg-light fixed-top px-4">
        <div class="ms-auto d-flex gap-2">
            <?php if(auth()->guard('web')->guest()): ?>
                <?php if(auth()->guard('mahasiswa')->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-success btn-sm">Login</a>
                    <a href="<?php echo e(route('mahasiswa.registrasi')); ?>" class="btn btn-outline-success btn-sm">Registrasi Mahasiswa</a>
                <?php else: ?>
                    <span class="fw-semibold text-secondary">Mahasiswa: <?php echo e(auth('mahasiswa')->user()->nama); ?></span>
                ...
                <?php endif; ?>
            <?php else: ?>
                <span class="fw-semibold text-secondary">Admin: <?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
                <form action="<?php echo e(route('logout')); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="btn btn-danger btn-sm">Logout</button>
                </form>
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="card shadow text-center p-5" style="max-width: 520px; width:100%;">
            ...
            <?php if(auth()->guard('web')->guest()): ?>
                <?php if(auth()->guard('mahasiswa')->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-success btn-lg mb-2 w-100">Login Menggunakan NIM</a>
                    <a href="<?php echo e(route('mahasiswa.registrasi')); ?>" class="btn btn-outline-success btn-lg w-100">Registrasi Mahasiswa</a>
                <?php else: ?>
    ...
    <footer class="text-center text-muted py-4">
        © <?php echo e(date('Y')); ?> Sistem Manajemen Data Mahasiswa | Laravel <?php echo e(Illuminate\Foundation\Application::VERSION); ?>
...
<?php /**PATH C:\Users\Jalaluddin\Desktop\Sistem Manajemen Data Mahasiswa\resources\views/welcome.blade.php ENDPATH**/ ?>